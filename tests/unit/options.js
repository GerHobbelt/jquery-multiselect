(function($) {
    ...
    test("multiple (changing dynamically)", function () {
        ...
        equal(menu().hasClass("ui-multiselect-single"), true, "...and the menu now has the single select class");
        ...
        equal(menu().hasClass("ui-multiselect-single"), false, "...and the menu doesn't have the single select class");
    ...
    test("header", function () {
        ...
        equal(countLinks(), 1, "number of links in the custom header config (should be close button)");
